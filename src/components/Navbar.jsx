...
function ShieldLogo({ size = 48 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 100 110" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="50" cy="50" r="22" stroke="#3B82F6" strokeWidth="0.5" strokeOpacity="0.4" fill="none" />
      <circle cx="50" cy="50" r="16" stroke="#60B8FF" strokeWidth="0.8" strokeOpacity="0.6" fill="none" />
      <circle cx="50" cy="50" r="10" stroke="#93C5FD" strokeWidth="1" strokeOpacity="0.8" fill="rgba(59,130,246,0.2)" />
      
      {/* Crosshair ticks */}
      <line x1="50" y1="32" x2="50" y2="36" stroke="#60B8FF" strokeWidth="1" strokeLinecap="round" />
      <line x1="50" y1="64" x2="50" y2="68" stroke="#60B8FF" strokeWidth="1" strokeLinecap="round" />
      <line x1="32" y1="50" x2="36" y2="50" stroke="#60B8FF" strokeWidth="1" strokeLinecap="round" />
      <line x1="64" y1="50" x2="68" y2="50" stroke="#60B8FF" strokeWidth="1" strokeLinecap="round" />
      
      {/* Core Glow */}
      <circle cx="50" cy="50" r="5" fill="#60B8FF" filter="url(#glow)" />
